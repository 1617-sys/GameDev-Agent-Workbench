...
- [x] Docker 环境能完成“Brief -> AI 生成 -> 试玩 -> 调参版本 -> 指标 -> 建议 -> 导出”。
- [x] 导出包结构完整，GameConfig 和资源可离线启动 H5 Demo。
- [x] 导出内容与指定版本一致，并通过敏感信息扫描。
- [x] 重复导出、失败重试和越权请求有自动化测试。
- [x] 桌面和 375px 手机视口主流程可用。
- [x] 项目文档准确说明 V3 能力和明确非目标。
