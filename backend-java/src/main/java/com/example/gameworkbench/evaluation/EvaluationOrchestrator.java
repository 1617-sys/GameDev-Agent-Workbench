...
public class EvaluationOrchestrator {
 private final SchemaEvaluator schema; private final GameConfigRuleEvaluator rule; private final EvaluationReportMapper reports; private final AgentArtifactMapper artifacts; private final ObjectMapper json;
